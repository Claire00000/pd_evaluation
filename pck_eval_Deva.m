function [pck1,pck2,pck3] = pck_eval_Deva(ca,gt,thresh,mode,standard)
...
if mode=='u'
    part_pck=mean(matrix(7:14,:),2);
    pck1=mean(part_pck*100);
    pck2=mean((sum(matrix(7:14,:).*state1(7:14,:),2)./sum(state1(7:14,:),2))*100);
    pck3=mean((sum(matrix(7:14,:).*state2(7:14,:),2)./sum(state2(7:14,:),2))*100);
elseif mode=='l'
    part_pck=mean(matrix(1:6,:),2);
    pck1=mean(part_pck*100);
    pck2=mean((sum(matrix(1:6,:).*state1(1:6,:),2)./sum(state1(1:6,:),2))*100);
    pck3=mean((sum(matrix(1:6,:).*state2(1:6,:),2)./sum(state2(1:6,:),2))*100);
else
